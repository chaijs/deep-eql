...
describe("Generic", function () {
  describe("strings", function () {
    ...
    it("returns false for literal vs instance with same value", function () {
      assert(
        eql("x", new String("x")) === false,
        'eql("x", new String("x")) === false'
      );
      assert(
        eql(new String("x"), "x") === false,
        'eql(new String("x"), "x") === false'
      );
    });
  ...
  describe("booleans", function () {
    ...
    it("returns true for instances with same value", function () {
      assert(
        eql(new Boolean(true), new Boolean(true)),
        "eql(new Boolean(true), new Boolean(true))"
      );
    });
    ...
    it("returns false for literal vs instance with same value", function () {
      assert(
        eql(true, new Boolean(true)) === false,
        "eql(true, new Boolean(true)) === false"
      );
    });
    ...
    it("returns false for literal vs instance with different values", function () {
      assert(
        eql(false, new Boolean(true)) === false,
        "eql(false, new Boolean(true)) === false"
      );
      assert(
        eql(new Boolean(false), true) === false,
        "eql(new Boolean(false), true) === false"
      );
    });
  ...
  describe("numbers", function () {
    ...
    it("returns true for NaN instances", function () {
      assert(
        eql(new Number(NaN), new Number(NaN)),
        "eql(new Number(NaN), new Number(NaN))"
      );
    });
    ...
    it("returns false on instances with different signs", function () {
      assert(
        eql(new Number(-1), new Number(1)) === false,
        "eql(new Number(-1), new Number(1)) === false"
      );
      assert(
        eql(new Number(-0), new Number(+0)) === false,
        "eql(new Number(-0), new Number(+0)) === false"
      );
      assert(
  ...
  describe("dates", function () {
    it("returns true given two dates with the same time", function () {
      var dateA = new Date();
      assert(
        eql(dateA, new Date(dateA.getTime())),
        "eql(dateA, new Date(dateA.getTime()))"
      );
    });
  ...
  describe("class instances", function () {
    ...
    it("returns false given two class instances with different properties", function () {
      ...
      assert(
        eql(new BaseA(1), new BaseA(2)) === false,
        "eql(new BaseA(1), new BaseA(2)) === false"
      );
    });
  ...
  describe("arguments", function () {
    ...
    it("returns false given two arguments with different properties", function () {
      ...
      assert(
        eql(argumentsA, argumentsB) === false,
        "eql(argumentsA, argumentsB) === false"
      );
    });
  ...
  describe("arrays", function () {
    ...
    it("returns false for arrays of different length", function () {
      assert(
        eql(new Array(1), new Array(100)) === false,
        "eql(new Array(1), new Array(100)) === false"
      );
    });
  });
  ...
  describe("objects", function () {
    ...
    it("returns false with objects containing different literals", function () {
      assert(
        eql({ foo: 1, bar: 1 }, { foo: 1, bar: 2 }) === false,
        "eql({ foo: 1, bar: 2 }, { foo: 1, bar: 2 }) === false"
      );
      assert(
        eql({ foo: "bar" }, { foo: "baz" }) === false,
        'eql({ foo: "bar" }, { foo: "baz" }) === false'
      );
      assert(
    ...
    it("returns false with objects containing different keys", function () {
      assert(
        eql({ foo: 1, bar: 1 }, { foo: 1, baz: 2 }) === false,
        "eql({ foo: 1, bar: 2 }, { foo: 1, baz: 2 }) === false"
      );
      assert(
        eql({ foo: "bar" }, { bar: "baz" }) === false,
        'eql({ foo: "bar" }, { foo: "baz" }) === false'
      );
    });
...
describe("Memoize", function () {
  it("returns true if WeakMap says so", function () {
    ...
    assert(
      eql(valueA, valueB, { memoize: memoizeMap }) === true,
  ...
  it("returns false if WeakMap says so", function () {
    ...
    memoizeMap.set(valueA, valueAMap);
    assert(
      eql(valueA, valueB, { memoize: memoizeMap }) === false,
...
describe("Comparator", function () {
  ...
  it("returns true if Comparator says so", function () {
    ...
    assert(
      eql(valueA, valueB, { comparator: specialComparator }) === true,
  ...
  it("returns true if Comparator says so even on primitives", function () {
    ...
    var valueB = { a: 1 };
    assert(
      eql(valueA, valueB, { comparator: matcherComparator }) === true,
  ...
  it("returns false if Comparator returns false (same objects)", function () {
    ...
    var valueB = { a: 1 };
    assert(
      eql(valueA, valueB, { comparator: falseComparator }) === false,
  ...
  it("resorts to deep-eql if Comparator returns null (same objects)", function () {
    ...
    var valueB = { a: 1 };
    assert(
      eql(valueA, valueB, { comparator: nullComparator }) === true,
  ...
  it("resorts to deep-eql behaviour if Comparator returns null (different objects)", function () {
    ...
    var valueB = { a: 2 };
    assert(
      eql(valueA, valueB, { comparator: nullComparator }) === false,
