...
describe("ES2015 Specific", function () {
  ...
  describeIf(
    symbolExists && typeof Array.prototype[Symbol.iterator] === "function"
    ...
    it("returns false for Arrays with different entries", function () {
      assert(
        eql([1, 2, 3][Symbol.iterator](), [4, 5, 6][Symbol.iterator]()) ===
          false,
  ...
  describeIf(typeof Array.prototype.entries === "function")(
  ...
  describeIf(mapExists)("maps", function () {
    it("returns true for Maps with same entries", function () {
      ...
      assert(
        eql(mapA, mapB),
        "eql(Map { a => 1, b => 2, c => 3 }, Map { a => 1, b => 2, c => 3 })"
      );
    });
  ...
  describeIf(
    symbolAndMapExist && typeof Map.prototype[Symbol.iterator] === "function"
    ...
    it("returns true for Map iterators with same entries", function () {
      ...
      mapB.set("c", 3);
      assert(
        eql(mapA[Symbol.iterator](), mapB[Symbol.iterator]()),
    ...
    it("returns false for Map iterators with different entries", function () {
      ...
      mapB.set("c", 6);
      assert(
        eql(mapA[Symbol.iterator](), mapB[Symbol.iterator]()) === false,
  ...
  describeIf(mapExists && typeof Map.prototype.entries === "function")(
    ...
    function () {
      ...
      it("returns false for Map iterators with different entries", function () {
        ...
        mapB.set("c", 6);
        assert(
          eql(mapA.entries(), mapB.entries()) === false,
  ...
  describeIf(
    symbolAndSetExist && typeof Set.prototype[Symbol.iterator] === "function"
    ...
    it("returns true for Sets with same entries", function () {
      ...
      setB.add("a");
      assert(
        eql(setA[Symbol.iterator](), setB[Symbol.iterator]()),
    ...
    it("returns false for Sets with different entries", function () {
      ...
      setB.add("f");
      assert(
        eql(setA[Symbol.iterator](), setB[Symbol.iterator]()) === false,
        'eql(Set { "a", "b", "c" }[Symbol.iterator](), Set { "d", "e", "f" }[Symbol.iterator]()) === false'
      );
    });
  });

  describeIf(setExists && typeof Set.prototype.entries === "function")(
    ...
    function () {
      ...
      it("returns false for Sets with different entries", function () {
        ...
        setB.add("f");
        assert(
          eql(setA.entries(), setB.entries()) === false,
  ...
  describeIf(typeof Symbol === "function")("symbol", function () {
    it("returns true for the same symbols", function () {
      ...
      assert(
        eql(Symbol.iterator, Symbol.iterator),
        "eql(Symbol.iterator, Symbol.iterator)"
      );
    });
  ...
  describeIf(typeof Promise === "function")("promise", function () {
    it("returns true for the same promises", function () {
      ...
      assert(
        eql(promiseResolve, promiseResolve),
        "eql(promiseResolve, promiseResolve)"
      );
      assert(
        eql(promiseReject, promiseReject),
        "eql(promiseReject, promiseReject)"
      );
      assert(
        eql(promisePending, promisePending),
        "eql(promisePending, promisePending)"
      );
    ...
    it("returns false for different promises", function () {
      ...
      assert(
        eql(promiseRejectA, promiseRejectB) === false,
  ...
  describeIf(typeof Uint8ClampedArray === "function")(
    "uint8clampedarray",
    function () {
      it("returns true for arrays with same values", function () {
        assert(
  ...
  describeIf(typeof Float32Array === "function")("float32array", function () {
    ...
    it("returns false for arrays with different values", function () {
      assert(
        eql(new Float32Array(1, 2, 3, 4), new Float32Array(5, 6, 7, 8)) ===
          false,
        "eql(new Float32Array(1, 2, 3, 4), new Float32Array(5, 6, 7, 8)) === false"
      );
      assert(
        eql(new Float32Array(1, 2, 3, 4), new Float32Array(4, 2, 3, 4)) ===
          false,
  ...
  describeIf(typeof Float64Array === "function")("float64array", function () {
    ...
    it("returns false for arrays with different values", function () {
      assert(
        eql(new Float64Array(1, 2, 3, 4), new Float64Array(5, 6, 7, 8)) ===
          false,
        "eql(new Float64Array(1, 2, 3, 4), new Float64Array(5, 6, 7, 8)) === false"
      );
      assert(
        eql(new Float64Array(1, 2, 3, 4), new Float64Array(4, 2, 3, 4)) ===
          false,
  ...
  describeIf(typeof DataView === "function")("dataview", function () {
    it("returns true for arrays with same values", function () {
      ...
      assert(eql(dataViewA, dataViewB), "eql(dataViewA, dataViewB)");
    });
  ...
  describeIf(supportArrows)("arrow function", function () {
    it("returns true for same arrow functions", function () {
      var arrow = eval("() => {}");
      assert(eql(arrow, arrow), "eql(arrow, arrow)");
    });
  ...
  describeIf(supportGenerators)("generator function", function () {
    it("returns true for same arrow functions", function () {
      ...
      assert(eql(generator, generator), "eql(generator, generator)");
    });

    it("returns false for different arrow functions", function () {
      assert(
        eql(
          eval("function * generator() {}; generator"),
          eval("function * generator() {}; generator")
        ) === false,
  ...
  describeIf(supportGenerators)("generator", function () {
    it("returns true for same generator function calls", function () {
      var generator = eval(
        "function * generator() { yield 1; yield 2; }; generator"
      );
      assert(eql(generator(), generator()), "eql(generator(), generator())");
    });
    ...
    it("returns true for different generator function calls that return same results", function () {
      var generatorA = eval(
        "function * generatorA() { yield 1; yield 2; }; generatorA"
      );
      var generatorB = eval(
        "function * generatorB() { yield 1; yield 2; }; generatorB"
      );
      assert(
    ...
    it("returns true for different generator function calls are at level of iteration with same results", function () {
      var generatorA = eval(
        "function * generatorA() { yield 1; yield 2; yield 3; }; generatorA"
      );
      var generatorB = eval(
        "function * generatorB() { yield 6; yield 2; yield 3; }; generatorB"
      );
    ...
    it("returns false for same generator function calls that return different results", function () {
      var generator = eval(
        "var set = 0; function * generator() { yield set++; }; generator"
      );
      assert(
